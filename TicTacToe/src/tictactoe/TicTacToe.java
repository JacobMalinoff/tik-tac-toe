...
public class TicTacToe {
    ...
    //This program creates a tictactoe board by entering blank spaces into the array. Numbers are placed into each sector of the board
    // and when the user enters that number their token will be placed in that sector of the board. 
    ...
    public static void main(String[] args) {
     ...
     placeToken(board , won); // places token. Method to check if wom is placed inside of this method
    }// end of main 
